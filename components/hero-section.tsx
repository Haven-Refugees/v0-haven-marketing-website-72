...
export function HeroSection() {
  return (
    <section className="relative flex items-center justify-center pt-24 pb-12 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 grid lg:grid-cols-2 gap-8 items-center">
        <div className="space-y-6">
          ...
          <h1 className="font-sans font-black text-4xl md:text-5xl lg:text-6xl text-foreground leading-tight text-balance">
            We help refugees become independent in Canada faster.
          </h1>
          
          <p className="font-sans font-medium text-lg text-muted-foreground max-w-lg leading-relaxed">
