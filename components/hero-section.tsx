...
export function HeroSection() {
  return (
    <section className="relative flex items-center justify-center min-h-[calc(100vh-40px)] pt-16 pb-8 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 py-2 grid lg:grid-cols-[7fr_3fr] gap-8 items-center">
