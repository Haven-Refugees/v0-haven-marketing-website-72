        ...
        <div className="grid md:grid-cols-2 gap-5 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-secondary-foreground/70 text-sm leading-relaxed mb-5">
              Online classes with professional teachers, plus weekly conversations with Canadian volunteers. The perfect program if you need to improve your English in Canada.
            </p>
