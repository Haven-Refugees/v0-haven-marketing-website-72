...
export function SectionNewcomers() {
  ...
  return (
    <section className="py-20 bg-haven-purple/10">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
          ...
          <div>
            ...
            <h2 className="font-sans font-bold text-3xl md:text-4xl text-foreground leading-tight mb-6 tracking-tight">
          ...
          <div className="flex justify-center">
            <div className="w-full h-[400px] rounded-2xl overflow-hidden shadow-[var(--shadow-card)]">
              <img 
