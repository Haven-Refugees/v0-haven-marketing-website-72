...
export function HLPTestimonialLidia() {
  ...
  return (
    <section className="relative min-h-[500px]">
      <div className="grid md:grid-cols-[40%_60%] h-full min-h-[500px] items-stretch">
        {/* Left - Photo */}
        ...
        {/* Right - Quote */}
        <div className="bg-[var(--bg-4)] p-8 md:p-10 lg:p-12 flex flex-col justify-center order-1 md:order-2 min-h-[500px]">
          <blockquote className="text-[var(--fg-1)] text-xl md:text-2xl lg:text-3xl font-bold leading-snug mb-4">
          ...
          <p className="font-sans text-[var(--fg-3)] text-base">
