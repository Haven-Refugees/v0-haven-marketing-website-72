  ...
  return (
    <section className="py-16 md:py-20 bg-haven-purple/10">
      <div className="max-w-[900px] mx-auto px-6">
        ...
        <p className="font-body text-[17px] text-muted-foreground max-w-[700px] mx-auto mb-12 text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-x-6 gap-y-10">
          {teachers.map((teacher, index) => (
            <div key={index} className="flex flex-col items-center text-center">
              <div className="w-[90px] h-[90px] rounded-full bg-haven-purple/20 overflow-hidden mb-3">
                <img
                  src={teacher.image}
                  alt={teacher.name}
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-[90px] h-[90px] rounded-full border-2 border-dashed border-haven-purple flex items-center justify-center mb-3">
              <span className="text-haven-purple text-xl font-semibold">
                30+
              </span>
            </div>
            <p className="text-sm font-semibold text-foreground">
